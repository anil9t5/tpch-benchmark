            ...
            for id_order in range(order_data_size):
                ...
                if O_ORDERKEY%4 ==0: #Only 25% of range key is populated
                    ...
                    for id_lineitem in range(data_size_lineitem):
                        ...
                        L_PARTKEY= random.randint(1,part_data_size)
                        ...
                        cur.execute("INSERT INTO ORDERS(O_ORDERKEY, O_CUSTKEY, O_ORDERSTATUS, O_TOTALPRICE, O_ORDERDATE, O_ORDERPRIORITY, O_CLERK, O_SHIPPRIORITY, O_COMMENT) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)", (str(O_ORDERKEY), str(O_CUSTKEY), O_ORDERSTATUS, str(O_TOTALPRICE), str(O_ORDERDATE), str(O_ORDERPRIORITY), str(O_CLERK), str(O_SHIPPRIORITY), O_COMMENT))
